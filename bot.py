...
service_api_mapping = {
    ...
    "لايكات تيكتوك 1k": {"service_id": 13720, "quantity_multiplier": 1000},
    "لايكات تيكتوك 2k": {"service_id": 13720, "quantity_multiplier": 2000},
    "لايكات تيكتوك 3k": {"service_id": 13720, "quantity_multiplier": 3000},
    "لايكات تيكتوك 4k": {"service_id": 13720, "quantity_multiplier": 4000},
...
def button_handler(update: Update, context: CallbackContext):
    ...
    # أوامر المستخدمين العادية
        ...
        if data == "show_services":
            ...
            # إضافة الملاحظة الخاصة بخدمات انستغرام دون تغيير باقي نص الإشعار
            note = ""
            if "انستغرام" in service_name:
                note = "\n\nتنبيه: يرجى إطفاء زر 'تميز للمراجعة' داخل حسابك الانستغرام لضمان إكمال طلبك!"
